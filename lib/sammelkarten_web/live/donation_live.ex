  ...
  def render(assigns) do
    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="text-center mb-12">
        <h1 class="text-4xl font-bold text-gray-900 mb-4">Support Sammelkarten</h1>
    ...
    <!-- Why Donate -->
      <div class="bg-white rounded-lg shadow-lg p-8 mb-12">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">Why Support This Project?</h2>
        <div class="grid md:grid-cols-3 gap-8">
          <a
            href="https://github.com/razue/sammelkarten"
            target="_blank"
            rel="noopener noreferrer"
            class="group block text-center rounded-lg transition transform hover:-translate-y-1 hover:shadow-xl hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-green-400"
          >
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-green-700 transition-colors">
              Open Source
            </h3>
            <p class="text-gray-600 group-hover:text-green-800 transition-colors">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="group block text-center rounded-lg transition transform hover:-translate-y-1 hover:shadow-xl hover:bg-purple-50 focus:outline-none focus:ring-2 focus:ring-purple-400"
          >
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-purple-700 transition-colors">
              Modern Tech
            </h3>
            <p class="text-gray-600 group-hover:text-purple-800 transition-colors">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="group block text-center rounded-lg transition transform hover:-translate-y-1 hover:shadow-xl hover:bg-orange-50 focus:outline-none focus:ring-2 focus:ring-orange-400"
          >
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-orange-700 transition-colors">
              Community Driven
            </h3>
            <p class="text-gray-600 group-hover:text-orange-800 transition-colors">
    ...
    <!-- Developer Info -->
      <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-8 text-center">
        <h2 class="text-2xl font-bold text-gray-900 mb-4">About the Developer</h2>
        ...
        <div class="flex justify-center space-x-4">
          <span class="bg-white px-4 py-2 rounded-lg text-sm font-medium text-gray-700">
            Elixir Enthusiast
          </span>
          <span class="bg-white px-4 py-2 rounded-lg text-sm font-medium text-gray-700">
            Bitcoin Advocate
